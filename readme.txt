...
1. Settings page.
1. Widgets page showing placement in Footer 2 widget area.
1. Post editor showing the Storemapper button that inserts a shortcode.
1. Post editor showing the Storemapper button form, allowing an optional title and HTML tag to surround the title.
1. Post editor showing the inserted shortcode.
1. Twentyseventeen theme showing the Storemapper shortcode output on a blog article.
...
= 2.0.0 =
* New version with storemapper block
